...
class DataProcess:
    ...
    def load_data(self, paths, mode='train'):
        ...
        # for i in range(len(frames_person_mark) - (self.seq_len - 1)):
            # if frames_person_mark[i] == frames_person_mark[i + self.seq_len - 1]:
            #     indices.append(i)
    ...
    def load_test_data(self, paths, category, mode='test'):
        '''
        frame -- action -- person_seq(a dir)
        :param paths: action_path list
        :return:
